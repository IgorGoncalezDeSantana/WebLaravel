...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-10">
            ...
            <form class ="mt-5" action = "{{route('produtos.store')}}" method="post">
                @csrf
                <div class="form-group">
                    <label for="ID_PRODUTO">ID Produto</label>
                    <input type="text" class="form-control"  placeholder="ID Produto" name="ID_PRODUTO" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control"  placeholder="Digite o preço do produto" name="PRECO" step=".01">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="PRECO_VENDA">Preço de venda</label>
                            <input type="number" min="0" class="form-control"  placeholder="Digite o preço de venda do produto" name="PRECO_VENDA" step=".01">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Digite a altura do produto" name="ALTURA">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="LARGURA">Largura</label>
                            <input type="text" class="form-control"  placeholder="Digite a largura do produto" name="LARGURA">
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-group">
                            <label for="COMPRIMENTO">Comprimento</label>
                            <input type="text" class="form-control"  placeholder="Digite o comprimento do produto" name="COMPRIMENTO">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="ID_IMAGEM">ID Imagem</label>
                    <input type="number" min="0" class="form-control"  placeholder="Digite o id da imagem do produto" name="ID_IMAGEM">
                </div>
                ...
                <div class="row">
                    <div class="col text-center">
                        <button type="submit" class="btn btn-success mt-3" value="Inserir" name="inserirProduto">Salvar</button>
